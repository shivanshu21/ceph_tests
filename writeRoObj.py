...
try:
    ...
    m.key = 'keynum5'
    print "\nU2: The keynum5 object has: " + m.get_contents_as_string()
    ##print "ACL: " + str(m.get_acl())
    print "U2: Write keynum5 object again"
    m.set_contents_from_string("DATADATADATADATADATADATADATA")
    print "Object now has: " + m.get_contents_as_string()
except:
